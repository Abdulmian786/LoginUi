...
namespace LoginUi.LoginDataSetTableAdapters {
    ...
    public partial class LoginInfoTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[LoginInfo] WHERE (([Id] = @Original_Id) AND ((@IsNull_UserName" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[LoginInfo] SET [UserName] = @UserName, [PassWord] = @PassWord WHERE (([Id] = @Original_Id) AND ((@IsNull_UserName = 1 AND [UserName] IS NULL) OR ([UserName] = @Original_UserName)) AND ((@IsNull_PassWord = 1 AND [PassWord] IS NULL) OR ([PassWord] = @Original_PassWord)));
SELECT Id, UserName, PassWord FROM LoginInfo WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::LoginUi.Properties.Settings.Default.LoginConnectionString;
        }
